...
<table align="center">
    ...
    <tr>
        <td><input type="text" class="formElement" name="ebay_sku" id="ebay_sku"/></td>
...
<script type="text/javascript">
    $('#btn-submit').click(function () {
        ...
        if ($ebay_sku == '' || $s_qty == '' || $sap_sku == '' || $t_qty == '' || $warehouse == '' || $factory == '' || $shipment_code == '') {
            alert('请填写所有内容');
            return false;
        }
        if ($s_qty < 1 || $t_qty < 1) {
        ...
        $.ajax({
            type: 'post',
            url: '/ebayOrderList/refreshSkuMatchTable',
            data: {
                ebay_sku: $ebay_sku,
                s_qty: $s_qty,
                sap_sku: $sap_sku,
            ...
            success: function (res) {
                ...
                if (res) {
                    if (res.flag == 1 || res.flag == 2) {
                        ...
                        if (res.flag == 2) {
                            location.href = '/ebayOrderList/skuMatchList';
                        }
                    } else {
                        alert(res.msg);
                    }
