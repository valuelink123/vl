...
<!--                        <th>标记完成</th>-->
    ...
    <script>
        ...
        $('#datatable').dataTable({
            ...
            processing: true,
            columns: [
                // {data: 'ebay_sap_id', name: 'ebay_sap_id'},
                // {data: 'site', name: 'site'},
                {data: 'ebay_order_id', name: 'ebay_order_id'},
                ...
                {data: 'ebay_sku_qty', name: 'ebay_sku_qty'},
        ...
        $("#export").click(function(){
            ...
            location.href='/ebayOrderList/export?'+search;
        });
        ...
        $('#skuMatchList').click(function(){
            window.open('/ebayOrderList/skuMatchList');
        });
