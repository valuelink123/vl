...
@section('content')
    ...
    <div id="switch-content">
        <div class="filter_content">
            <select name="" class="bgList" onchange="status_filter(this.value,11)">
                <option value="">All BG</option>
                <option value="BG1">BG1</option>
                <option value="BG3">BG3</option>
                <option value="BG4">BG4</option>
            </select>
            <select name="" onchange="status_filter(this.value,12)">
                ...
                <table class="table table-striped table-bordered" id="thetable">
                    ...
                    @foreach($data as $key=>$val)
                        ...
                        <!-- <th>{!! $val['target_review'] !!}</th>
                            ...
                            <th>{!! @$val['d-6']?$val['d-6']:'' !!}</th>
                            <th>{!! @$val['d-5']?$val['d-5']:'' !!}</th>
                            <th>{!! @$val['d-4']?$val['d-4']:'' !!}</th>
                            <th>{!! @$val['d-3']?$val['d-3']:'' !!}</th>
                            <th>{!! @$val['d-2']?$val['d-2']:'' !!}</th>
                            <th>{!! @$val['d-1']?$val['d-1']:'' !!}</th>
                            <th>{!! @$val['d-0']?$val['d-0']:'' !!}</th>
                            <th>{!! @$val['d1']?$val['d1']:'' !!}</th>
                            <th>{!! @$val['d2']?$val['d2']:'' !!}</th>
                            <th>{!! @$val['d3']?$val['d3']:'' !!}</th>
                            <th>{!! @$val['d4']?$val['d4']:'' !!}</th>
