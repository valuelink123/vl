...
@section('crumb')
    <a href="/manageDistributeTime/fba">FBA-FC Transfer time</a>
@endsection
@section('content')
<style>
	.title{
...
<div>
	...
	<table id="fbaTable" class="display table-striped table-bordered table-hover" style="width:100%;margin-top: 10px;">
			<thead>
