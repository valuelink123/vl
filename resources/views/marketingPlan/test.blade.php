...
<div>
	<div class="button_box">
			{{--<form id="fileupload" action="/shipment/importExecl" method="POST" enctype="multipart/form-data">--}}
				...
				{{--</div>--}}
			{{--</form>--}}
		   <form class="form1" action="http://10.10.42.14/vl/public/shipment/importExecl" style="display: inline-block;" method="POST" enctype="multipart/form-data">
			{{--<form id="fileupload" action="/shipment/importExecl" method="POST" enctype="multipart/form-data">--}}
			<input type="file" name="files" id="input" multiple="">
			<button type="submit" id="uploadFrom" class="btn blue start">
				<i class="fa fa-upload"></i>
				<span>开始上传</span>
			</button>
		</form>
