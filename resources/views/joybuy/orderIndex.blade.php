...
@section('crumb')
@include('layouts.crumb', ['crumbs'=>['joybuy order List']])
@endsection
@section('content')
            ...
            <form id="search-form">
                <div class="col-md-2">
                    <div class="input-group">
                        ...
                        <input class="form-control" value="{!! $data['fromDate'] !!}" data-date-format="yyyy-mm-dd"
                               data-options="format:'yyyy-mm-dd'" id="from_date" name="from_date"/>
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon">To Date</span>
                        <input class="form-control" value="{!! $data['toDate'] !!}" data-change="0"
                               data-date-format="yyyy-mm-dd" data-options="format:'yyyy-mm-dd'" id="to_date"
                               name="to_date"/>
                    </div>
                </div>
                <div class="col-md-2">
...
<!--                        <select style="width:100%;height:35px;" data-recent="" data-recent-date="" id="site" onchange=""-->
<!--                                name="site">-->
...
<script>
    ...
    $('#search_table').click(function () {
        // 若页面上输入的order_id, 序列化后的空格和换行分别变成了+，%09
