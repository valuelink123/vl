...
<form action="{{ url('/joybuyOrderList/skuMatchUpdate') }}" id="skuMatch_form" method="POST">
    {{ csrf_field() }}
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input type="text" class="form-control" name="joybuy_sku" id="joybuy_sku"
                                               value="{{$data['joybuy_sku']}}">
                                    </div>
                                </div>
                                <div class="form-group">
