...
@section('label', 'Role List')
@section('content')
    <h1 class="page-title font-red-intense"> Role List
            ...
            <div class="portlet light bordered">
                ...
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{ url('role/create')}}"><button id="sample_editable_1_2_new" class="btn sbold blue"> Add New
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="manage_role">
                        <thead>
                        <tr>
                            <th > ID </th>
                            <th> Role Name </th>
