	    ...
	    <div class="tab_content">
		    <div class="tab-item">
				...
				<div class="tab-item-body">
					<ul>
						<li><label for="">部门</label> <span>BI项目组</span></li>
						<li><label for="">上级部门</label> <span>抓客运营部</span></li>
						<li><label for="">一级部门</label> <span>电商服务事业部</span></li>
						<li><label for="">部门长</label> <span>杨明</span></li>
						<li><label for="">权限</label> <span>Home, Task, Listing, Review, Marketing, Inventory, Price, Email, Tools, KMS, Report Settings
						Home, Task, Listing, Review, Marketing, Inventory, Price, Email, Tools, KMS, Report Settings
						Home, Task, Listing, Review, Marketing, Inventory, Price, Email, Tools, KMS, Report Settings
						Home, Task, Listing, Review, Marketing, Inventory, Price, Email, Tools, KMS, Report Settings
						Home, Task, Listing, Review, Marketing, Inventory, Price, Email, Tools, KMS, Report Settings
						Home, Task, Listing, Review, Marketing, Inventory, Price, Email, Tools, KMS, Report Settings
		...
		<ul class="department_list">
			...
			<li>
				...
				<div class="permissions_li2" style="margin: 22px 0 0 84px; display: none;">
					...
					<select name="" class="copy_permission">
						<option value="">人员</option>
					</select>
				</div>
			</li>
				...
				{data: 'ff'},
				{
					...
					createdCell: function (cell, cellData, rowData, rowIndex, colIndex) {
						...
						element.click(function(){
							let reselling_switch = rowData.gg;
