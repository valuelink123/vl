        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="table-toolbar">
                    <form role="form" action="{{url('skuSize')}}" method="GET">
                        {{ csrf_field() }}
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <a data-target="#ajax" data-toggle="modal" href="/skuSize/0/edit"> 					   
                            ...
                            <div class="col-md-8" style="text-align:right;">
                                ...
                                <a href="{{ url('/uploads/da/skuSize.xls')}}" class="help-inline" style="margin-top:8px;margin-left:10px;">Template </a>
                            </div>
