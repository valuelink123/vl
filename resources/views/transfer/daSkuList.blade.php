...
@section('label', 'Da Sku与SAP Sku匹配列表 （双方不一致的才需要匹配）')
@section('content')
<style type="text/css">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="table-toolbar">
                    <form role="form" action="{{url('daSkuMatch')}}" method="GET">
                        {{ csrf_field() }}
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <a data-target="#ajax" data-toggle="modal" href="/daSkuMatch/0/edit"> 					   
                            ...
                            <div class="col-md-8" style="text-align:right;">
                                ...
                                <a href="{{ url('/uploads/da/daSkuMatch.xls')}}" class="help-inline" style="margin-top:8px;margin-left:10px;">Template </a>
                            </div>
