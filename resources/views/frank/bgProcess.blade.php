...
@section('crumb')
    @include('layouts.crumb', ['crumbs'=>[['Buy one get one', '/cb/list'], 'Process']])
@endsection
@section('content')
    ...
    <h1 class="page-title font-red-intense"> Buy one get one Process
        <small></small>
    </h1>
        ...
        <div class="portlet-body">
            <div>
                <ul class="nav nav-tabs" role="tablist" id="tabs">
                    <li role="presentation"><a href="#ctg-info" aria-controls="ctg-info" role="tab" data-toggle="tab">Buy one get one Info</a></li>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            @foreach($order['orderItems'] as $item)
                                                <tr>
                                                    ...
                                                    <td class="text-center sbold">{{round($item['ItemPriceAmount']/(($item['QuantityOrdered']>0)?$item['QuantityOrdered']:1),2)}}</td>
