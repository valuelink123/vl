...
@section('crumb')
    @include('layouts.crumb', ['crumbs'=>[['CashBack', '/cb/list'], 'Process']])
@endsection
@section('content')
    ...
    <h1 class="page-title font-red-intense"> CashBack Process
        <small></small>
    </h1>
        ...
        <div class="portlet-body">
            <div>
                <ul class="nav nav-tabs" role="tablist" id="tabs">
                    <li role="presentation"><a href="#ctg-info" aria-controls="ctg-info" role="tab" data-toggle="tab">CashBack Info</a></li>
