...
@section('crumb')
    @include('layouts.crumb', ['crumbs'=>['ccp ad group dashboard']])
@endsection
<style>
    .total-data-table{
        width:50%;
...
@section('content')
    ...
    <script>
        ...
        $('#export_table').click(function(){
            ...
            location.href='/ccp/adGroup/export?'+search+'&account='+accountid;
            return false;
        })
