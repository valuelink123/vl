    ...
    <div class="row">
        ...
        <div class="top portlet light">
            <table class="top-total-data total-data-table">
                ...
                <tr class="third">
                    <td>NET REVENUE:<span class="revenue">0</span>&nbsp;<span class="danwei"></span><BR>
                    INCOME:<span class="income">0</span>&nbsp;<span class="danwei"></span></td>
        ...
        $('#search_top').click(function(){
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $('.total-data-table .income').text(res.income);
