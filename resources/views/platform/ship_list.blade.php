...
<style type="text/css">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="table-toolbar">
                    <form role="form" action="{{url('platformship')}}" method="GET">
                        {{ csrf_field() }}
                        <div class="row">
                        <div class="col-md-2">
						...
						<div class="col-md-2">
						<input type="text" class="form-control " name="platform_shipping_method" placeholder="平台发货方式">
						</div>
						
						<div class="col-md-2">
						<input type="text" class="form-control" name="shipping_method" placeholder="谷仓发货方式">
						</div>
						<div class="col-md-2">
                ...
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">平台发货方式对照表</span>
                        <a data-target="#ajax" data-toggle="modal" href="/platformship/create"> 
    ...
    <script>
        ...
        var initTable = function () {
			...
			grid.setAjaxParam("platform_shipping_method", $("input[name='platform_shipping_method']").val());
			grid.setAjaxParam("warehouse_code", $("input[name='warehouse_code']").val());
            grid.setAjaxParam("shipping_method", $("input[name='shipping_method']").val());
            ...
            $(".btn-group").unbind("click").on('click', '.table-status-action-submit', function (e) {
                ...
                if (confirmStatus.val() != "" && grid.getSelectedRowsCount() > 0) {
                    ...
                    $.ajax({
                        type: "POST",
                        dataType: "json",
                        url: "{{ url('platformship/batchUpdate') }}",
...
$(function() {
	...
	$('#datatable_ajax').on('click', 'td:not(:has(input))', function (e) {
        ...
        $('#ajax').modal({
            remote: '/platformship/'+recordId+'/edit'
        });
    } );
