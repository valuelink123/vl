...
<form action="{{ url('/letianOrderList/skuMatchUpdate') }}" id="skuMatch_form" method="POST">
    {{ csrf_field() }}
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input type="text" class="form-control" name="letian_sku" id="letian_sku"
                                               value="{{$data['letian_sku']}}">
                                    </div>
                                </div>
                                <div class="form-group">
