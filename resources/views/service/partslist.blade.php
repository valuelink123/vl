...
//        })
        ...
        $theTable.dataTable({
            ...
            processing: true,
            aoColumnDefs: [
                { "bSortable": false, "aTargets": [ 6,9 ] },
                ],
            columns: [
                {data: 'item_code', name: 'item_code', width: '65px'},
                {data: 'seller_name', name: 'seller_name', width: '92px'},
                {data: 'asin', name: 'asin', width: '68px'},
                {data: 'seller_sku', name: 'seller_sku', width: '86px'},
                {data: 'item_name', name: 'item_name', width: '86px'},
                {data: 'fbm_stock', name: 'fbm_stock', width: '80px'},
                {data: 'fbm_valid_stock', name: 'fbm_valid_stock', width: '105px'},
                {data: 'fba_stock', name: 'fba_stock', width: '75px'},
                {data: 'fba_transfer', name: 'fba_transfer', width: '95px'},
                {data: 'unsellable', name: 'unsellable', width: '69px'},
                {data: 'fbm_update', name: 'fbm_update', width: '93px'},
                {data: 'fba_update', name: 'fba_update', width: '88px'},
                {
                    width: "15px",
