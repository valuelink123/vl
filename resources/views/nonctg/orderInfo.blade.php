            ...
            <div class="row invoice-head">
                <div class="col-md-7 col-xs-6">
                    <div class="invoice-logo">
                        <h1 class="uppercase">{!! $order['AmazonOrderId'] !!} ( {!! $order['SellerName'] !!} ) {{(checkRsgOrder($orderid)?'<span class="label label-lg label-danger">RSG ORDER</span>':'')}}</h1>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($order['orderItems'] as $item)
                            <tr>
                                ...
                                <td class="text-center sbold">{{($item['QuantityOrdered'])?round($item['ItemPriceAmount']/$item['QuantityOrdered'],2):0}}</td>
