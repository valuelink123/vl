...
@section('label', 'Amazon Settlement Detail Report')
@section('content')
<style type="text/css">
th,td,td>span {
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
                                    <input type="text" class="form-control" readonly name="posted_date_from" placeholder="PostedDateFrom" value="">
                            ...
                            <div class="col-md-2">
                                <div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
                                    <input type="text" class="form-control" readonly name="posted_date_to" placeholder="PostedDateTo" value="">
                                    <span class="input-group-btn">
                                        <button class="btn default" type="button">
                                            <i class="fa fa-calendar"></i>
                                        </button>
                        ...
                        <table class="table table-checkable table-striped table-bordered table-hover" id="datatable_ajax_report">
                            <thead>
                                <tr role="row" class="heading">
                                    ...
                                    <th>Shipment Fee Type</th>
                                    <th>Shipment Fee Amount</th>
                                    <th>Order Fee Type</th>
                                    <th>Order Fee Amount</th>
                                    ...
                                    <th>Item Related Fee Amount</th>
                                    <th>Misc Fee Amount</th>
                                    <th>Other Fee Amount</th>
                                    <th>Other Fee Reason Description</th>
                                    <th>Promotion Id</th>
                                    <th>Promotion Type</th>
                                    <th>Promotion Amount</th>
                                    <th>Direct Payment Type</th>
...
<script>
    var TableDatatablesAjax = function () {
        ...
        grid.setAjaxParam("type", 'amazon_settlement_details');
        grid.init({
        ...
        $('#data_search').on('click',function(e){
            e.preventDefault();
            grid.setAjaxParam("type", 'amazon_settlement_details');
            grid.setAjaxParam("posted_date_from", $("input[name='posted_date_from']").val());
            grid.setAjaxParam("posted_date_to", $("input[name='posted_date_to']").val());
        ...
        $("#select_export").click(function(){
            ...
            var baseUrl ='/reports/get?type=amazon_settlement_details&action=export&id='+grid.getSelectedRows();
            location.href =  baseUrl;
        });

        $("#current_export").click(function(){
            var baseUrl ='/reports/get?type=amazon_settlement_details&action=export&'+ $('#update_form').serialize();
