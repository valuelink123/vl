...
{
	return array('DBPOWER','TENKER','KOIOS','SPACEKEY','Mooka','Natrogix','Miropure','NURSAL','DROCON','Runme','OXA','Lyps','SPACEKEYBRANDS','TECBEAN','Babysteps','VIPSUPPORT','AZEUS','PureMeHome');
}
...
function getBrands(){
	return array(
		'DBPOWER'=>[
			'url'=>'dbpowershop.com',
			'email'=>'support@dbpowershop.com',
		],
		'KOIOS'=>[
			'url'=>'koiosshop.com',
			'email'=>'support@koiosshop.com',
		],
		'Miropure'=>[
			'url'=>'miropureshop.com',
		...
		'Tenker'=>[
			'url'=>'tenkershop.com',
			'email'=>'support@tenkershop.com',
		],
		'DROCON'=>[
			'url'=>'droconshop.com',
			'email'=>'support@droconshop.com',
		],
		'Natrogix'=>[
			'url'=>'natrogixshop.com',
			'email'=>'support@natrogixshop.com',
		],
		'Spacekey'=>[
			'url'=>'spacekeyshop.com',
			'email'=>'support@spacekeyshop.com',
		],
		'cocohop'=>[
			'url'=>'cocohopshop.com',
			'email'=>'support@cocohopshop.com',
		],
		'Funavo'=>[
			'url'=>'thefunavo.com',
			'email'=>'support@thefunavo.com',
		],
		'Lacette'=>[
			'url'=>'lacetteshop.com',
			'email'=>'support@lacetteshop.com',
		],
		'Petlucky'=>[
			'url'=>'petluckyshop.com',
			'email'=>'support@petluckyshop.com',
		],
		'WORKIZE'=>[
			'url'=>'workizeshop.com',
			'email'=>'support@workizeshop.com',
		],
		'VIDOKA'=>[
			'url'=>'myvidoka.com',
			'email'=>'support@myvidoka.com',
		],
		'DBPowerJP'=>[
			'url'=>'dbpowershop.jp',
			'email'=>'service@dbpowershop.jp',
		],
		'VipsupportJP'=>[
			'url'=>'vip-support.jp',
			'email'=>'service@vip-support.jp',
		],
		'Cozy Buy'=>[
			'url'=>'cozybuyonline.com',
			'email'=>'support@cozybuyonline.com',
		],
		'Runme'=>[
			'url'=>'runmesport.com',
...
function func_substr_replace($str, $replacement = "*", $start = 3, $length = 6)
{
