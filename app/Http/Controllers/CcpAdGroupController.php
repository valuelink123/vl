...
class CcpAdGroupController extends Controller
{
	...
	public function index()
	{
		...
		return view('ccp/ad_group',['site'=>$site,'date'=>$date,'siteDate'=>$siteDate]);
	}
	/*
	* 获得统计总数据
	 */
	public function showTotal()
	{
		...
		$sql ="SELECT  
			...
			LEFT JOIN ppc_reports ON (
					ppc_reports.record_type = 'Ppc::AdGroup'
					AND ppc_ad_groups.ad_group_id = ppc_reports.record_type_id
			)
			WHERE
	...
	public function list(Request $req)
	{
		...
		$sql = "SELECT SQL_CALC_FOUND_ROWS 
			...
			left join ppc_campaigns on ppc_ad_groups.campaign_id = ppc_campaigns.campaign_id 
