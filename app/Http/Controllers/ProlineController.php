    ...
    public function get(Request $request)
    {
		...
		foreach ( $lists as $list){
			...
			array(
				...
				$list['FBAPRICE'],
				$list['VERPR_FBA'],
				$list['FBAPRICE']+round($list['sku_price']*$list['ZCRATIO']/100,2)+(($list['RATE'])?round($list['VERPR_FBA']/$list['RATE']):$list['VERPR_FBA']),
				...
				$list['YCL'],
				round((($list['sku_price'])?(($list['sku_price']-($list['FBAPRICE']+round($list['sku_price']*$list['ZCRATIO']/100,2)+(($list['RATE'])?round($list['VERPR_FBA']/$list['RATE']):$list['VERPR_FBA'])))/$list['sku_price']):0)-round($list['YCL'],4),2),
