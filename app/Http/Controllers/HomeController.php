...
class HomeController extends Controller
{
	...
	public function Export(Request $request){
		...
		$arrayData[] = ['物料号','站点','订单金额','销量','总成本','操作费','交易费','其他费用','退货数量','Deal营销费','Coupon营销费','CPC营销费','FBM仓储费','FBA仓储费','资金占用成本','经济效益','业务净利润','销售目标','利润目标','销售完成率','利润完成率','提成基数'];
		...
		$arrayData[] = ['物料号','站点','日期','产品状态','销售员ID','BG','BU','采购单价','体积','尺寸','关税单价','头程运费单价','单位仓储费','人工成本','订单金额','销量','操作费','交易费','其他费用','退货数量','Deal营销费','Coupon营销费','CPC营销费','FBM库存','FBM仓储费','FBA库存','FBA仓储费','库存金额','资金占用成本','经济效益','业务净利润','保留品基数','淘汰品基数1','淘汰品基数2','销售目标','利润目标','销售完成率','利润完成率','提成基数'];
